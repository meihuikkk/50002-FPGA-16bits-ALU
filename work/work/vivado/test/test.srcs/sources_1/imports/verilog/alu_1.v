...
module alu_1 (
  ...
  always @* begin
    ...
    M_alu_shift_a = a;
    M_alu_shift_b = b;
    M_alu_shift_alusignal = alufn;
    M_alu_compare_v = v;
    M_alu_compare_z = z;
    M_alu_compare_n = n;
    M_alu_compare_alusignal = alufn;
    M_alu_boolean_a = a;
    M_alu_boolean_b = b;
    M_alu_boolean_alusignal = alufn;
